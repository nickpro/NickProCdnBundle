<?php
namespace Nickpro\CdnBundle\Tests\Filemanager;

use Symfony\Bundle\FrameworkBundle\Test\WebTestCase;
use Symfony\Component\HttpFoundation\File\UploadedFile;
use Nickpro\CdnBundle\Filemanager\Filemanager;
...
class FilemanagerTest extends WebTestCase
{
    ...
    public function setUp()
    {
        ...
        clearstatcache();
        $this->createGdImage();
        $this->fm = static::$kernel->getContainer()->get('nickpro_cdn.filemanager');
        parent::setUp();
    }
